...
export const SHOWCASE_MASSING: Massing[] = [
  ...
  { roomId: 'salon', x: 2.4, y: 0.48, w: 0.9, d: 0.36, h: 0.85, shape: 'table', tone: 'bois' },
  ...
  { roomId: 'salon', x: 0.58, y: 0.45, w: 0.24, d: 0.2, h: 2.95, base: 0.06, moelleux: true, shape: 'rideau', tone: 'lin' },
  { roomId: 'salon', x: 4.22, y: 0.45, w: 0.24, d: 0.2, h: 2.95, base: 0.06, moelleux: true, shape: 'rideau', tone: 'lin' },
  { roomId: 'salon', x: 2.4, y: 0.45, w: 3.98, d: 0.03, h: 0.03, base: 3.05, tone: 'laiton' },
  { roomId: 'salon', x: 0.48, y: 1.38, w: 0.2, d: 0.24, h: 2.75, base: 0.06, moelleux: true, shape: 'rideau', tone: 'lin' },
  { roomId: 'salon', x: 0.48, y: 3.62, w: 0.2, d: 0.24, h: 2.75, base: 0.06, moelleux: true, shape: 'rideau', tone: 'lin' },
  ...
  { roomId: 'salon', x: 1.9, y: 2.7, w: 0.03, d: 0.03, h: 0.3, base: 2.89, tone: 'laiton' },
  { roomId: 'salon', x: 1.9, y: 2.7, w: 0.46, d: 0.46, h: 0.34, base: 2.55, shape: 'suspension', tone: 'laiton' },
  ...
  { roomId: 'salle-a-manger', x: 5.15, y: 0.45, w: 0.24, d: 0.2, h: 2.95, base: 0.06, moelleux: true, shape: 'rideau', tone: 'lin' },
  { roomId: 'salle-a-manger', x: 8.65, y: 0.45, w: 0.24, d: 0.2, h: 2.95, base: 0.06, moelleux: true, shape: 'rideau', tone: 'lin' },
  ...
  { roomId: 'salle-a-manger', x: 7.55, y: 2.4, w: 0.03, d: 0.03, h: 0.32, base: 2.87, tone: 'laiton' },
  { roomId: 'salle-a-manger', x: 7.55, y: 2.4, w: 0.46, d: 0.46, h: 0.32, base: 2.55, shape: 'suspension', tone: 'laiton' },
  ...
  { roomId: 'chambre', x: 9.58, y: 0.45, w: 0.24, d: 0.2, h: 2.75, base: 0.06, moelleux: true, shape: 'rideau', tone: 'lin' },
  { roomId: 'chambre', x: 12.02, y: 0.45, w: 0.24, d: 0.2, h: 2.75, base: 0.06, moelleux: true, shape: 'rideau', tone: 'lin' },
  ...
  { roomId: 'chambre', x: 10.6, y: 1.6, w: 0.03, d: 0.03, h: 0.34, base: 2.85, tone: 'laiton' },
  { roomId: 'chambre', x: 10.6, y: 1.6, w: 0.46, d: 0.46, h: 0.3, base: 2.55, shape: 'suspension', tone: 'laiton' },
  ...
  { roomId: 'suite', x: 13.38, y: 0.45, w: 0.24, d: 0.2, h: 2.75, base: 0.06, moelleux: true, shape: 'rideau', tone: 'lin' },
  { roomId: 'suite', x: 15.82, y: 0.45, w: 0.24, d: 0.2, h: 2.75, base: 0.06, moelleux: true, shape: 'rideau', tone: 'lin' },
  { roomId: 'suite', x: 14.6, y: 0.45, w: 2.78, d: 0.03, h: 0.03, base: 2.85, tone: 'laiton' },
  { roomId: 'suite', x: 15.96, y: 1.18, w: 0.2, d: 0.24, h: 2.75, base: 0.06, moelleux: true, shape: 'rideau', tone: 'lin' },
  { roomId: 'suite', x: 15.96, y: 3.42, w: 0.2, d: 0.24, h: 2.75, base: 0.06, moelleux: true, shape: 'rideau', tone: 'lin' },
  ...
  { roomId: 'suite', x: 14.4, y: 2.4, w: 0.03, d: 0.03, h: 0.32, base: 2.87, tone: 'laiton' },
  { roomId: 'suite', x: 14.4, y: 2.4, w: 0.46, d: 0.46, h: 0.32, base: 2.55, shape: 'suspension', tone: 'laiton' },
