...
// --- 4. les feuilles de style servies, tous écrans confondus ---
const hrefs = sheets;
let css = '';
...
fs.writeFileSync(
  `${OUT}/extrait.json`,
  JSON.stringify({ css, assets, screens: { accueil, visite, espace, tableau }, slug: pub.slug }),
);
